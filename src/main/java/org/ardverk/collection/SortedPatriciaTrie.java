 ...
 * @author Sam Berlin
 */
public class SortedPatriciaTrie<K, V> extends PatriciaTrie<K, V> implements SortedTrie<K, V> {
     ...
     * {@inheritDoc}
     */
    public SortedPatriciaTrie(KeyAnalyzer<? super K> keyAnalyzer) {
        super(keyAnalyzer);
    }
    ...
    private abstract class RangeMap extends AbstractMap<K, V>
        ...
        //@Override
        public Comparator<? super K> comparator() {
            return SortedPatriciaTrie.this.comparator();
        }
        ...
        public boolean containsKey(Object key) {
            ...
            return SortedPatriciaTrie.this.containsKey(key);
        }
        ...
        public V remove(Object key) {
            ...
            return SortedPatriciaTrie.this.remove(key);
        }
        ...
        public V get(Object key) {
            ...
            return SortedPatriciaTrie.this.get(key);
        }
        ...
        public V put(K key, V value) {
            ...
            return SortedPatriciaTrie.this.put(key, value);
        }
    ...
    private class RangeEntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        @Override
        public int size() {
            if (size == -1 || expectedModCount != SortedPatriciaTrie.this.modCount) {
                size = 0;
                ...
                expectedModCount = SortedPatriciaTrie.this.modCount;
            }
            return size;
        }
    ...
    private class PrefixRangeMap extends RangeMap {
        ...
        private int fixup() {
            ...
            if (size == -1 || SortedPatriciaTrie.this.modCount != expectedModCount) {
    ...
    private final class PrefixRangeEntrySet extends RangeEntrySet {
        ...
        @Override
        public Iterator<Map.Entry<K, V>> iterator() {
            if (SortedPatriciaTrie.this.modCount != expectedModCount) {
        ...
        private final class SingletonIterator implements Iterator<Map.Entry<K, V>> {
            ...
            public void remove() {
                ...
                ++hit;
                SortedPatriciaTrie.this.removeEntry(entry);
            }
        }
        ...
        private final class EntryIterator extends TrieIterator<Map.Entry<K, V>> {
            ...
            EntryIterator(TrieEntry<K, V> startScan, K prefix,
                ...
                subtree = startScan;
                next = SortedPatriciaTrie.this.followLeft(startScan);
                this.prefix = prefix;
                this.offset = offset;
                this.lengthInBits = lengthInBits;
            }
            ...
            protected TrieEntry<K, V> findNext(TrieEntry<K, V> prior) {
                return SortedPatriciaTrie.this.nextEntryInSubtree(prior, subtree);
            }
