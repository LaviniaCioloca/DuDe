...
import lrg.dude.duplication.DuDe;
import lrg.dude.duplication.model.CodeFragment;
import lrg.dude.duplication.model.Coordinate;
import lrg.dude.duplication.model.CoordinateList;
import lrg.dude.duplication.model.Duplication;
import lrg.dude.duplication.model.DuplicationList;
import lrg.dude.duplication.model.DuplicationType;
import lrg.dude.duplication.model.Entity;
import lrg.dude.duplication.model.IMethodEntity;
import lrg.dude.duplication.model.MatrixLine;
import lrg.dude.duplication.model.MatrixLineList;
import lrg.dude.duplication.model.Parameters;
import lrg.dude.duplication.model.SourceFile;
import lrg.dude.duplication.model.StringList;
import lrg.dude.duplication.model.VirtualColumnMatrix;
import lrg.dude.duplication.strategies.IdenticalCompareStrategy;
import lrg.dude.duplication.strategies.StringCompareStrategy;
import lrg.dude.duplication.utils.DirectoryReader;
import lrg.dude.duplication.utils.DuplicationUtil;
...
public class SuffixTreeProcessor extends Processor {
    ...
    private boolean checkIfTestFilesAreAccepted(String absolutePath) {
        if (absolutePath.contains("test") || absolutePath.contains("Test")) {
            return params.isConsiderTestFiles();
        }
